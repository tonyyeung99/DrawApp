...
public class TestConsoleDrawEngineDrawLine {
	...
	public void testDrawLineEdgeLeft() throws FileNotFoundException{
		 ...
		 engine.renderLine(1, 1 , 1, 4);
		 testLine1Canvas = engine.getCanvas().exportPixels();
		 
		 /*
		 for(int i=0; i<testLine1Canvas.length;i++){
			 System.out.println(testLine1Canvas[i]);
		 }
		 
		 System.out.println("row = " + testLine1Canvas.length);
		 System.out.println("col = " + testLine1Canvas[0].length);
		 System.out.println((int) testLine1Canvas[0][0]);
		 System.out.println("********");
		 for(int i=0; i<expectLine1Canvas.length;i++){
			 System.out.println(expectLine1Canvas[i]);
		 }	
		 System.out.println("row = " + expectLine1Canvas.length);
		 System.out.println("col = " + expectLine1Canvas[0].length);
		 
		 System.out.println((int) expectLine1Canvas[0][0]);
		 */
